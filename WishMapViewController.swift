...
final class WishMapEditorViewController: UIViewController,
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            canvasView.heightAnchor.constraint(equalTo: canvasView.widthAnchor, multiplier: 1.15),

            bottomPanel.topAnchor.constraint(equalTo: canvasView.bottomAnchor, constant: 16),
